...
class ExpressionCodegen(
    ...
    private fun generateNonNullAssertions() {
        ...
        if (inlinedInto != null ||
            ...
            irFunction.parentAsClass.origin.let { parentClassOrigin ->
                parentClassOrigin == JvmLoweredDeclarationOrigin.CONTINUATION_CLASS ||
                        parentClassOrigin == JvmLoweredDeclarationOrigin.SUSPEND_LAMBDA ||
                        parentClassOrigin == JvmLoweredDeclarationOrigin.DEFAULT_IMPLS
            } ||
